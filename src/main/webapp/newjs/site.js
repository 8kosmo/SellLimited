...
function quick_open_top() {
	if($('#toggle').val() == 1){
		...
		$('#quick_arrow').attr('src','/images/quick_close.png');
		$('#toggle').val(1);
		quick_switch('2', 0);
	}
}
...
function quick_open() {
	...
	$('#quick_arrow').attr('src','/images/quick_close.png')
	$("#quickTapbox").attr('class','quickTapbox_wrap');
	$("#quickTapbg").attr('class','quickTapbg_wrap');
	$("#quickTapbox2").show();
...
function quick_close(){
	$('#quick_arrow').attr('src','/images/quick_open.png')
	$("#quickTapbox").attr('class','quickTapbox');
	$("#quickTapbg").attr('class','quickTapbg');
	for(i=0;i<10;i++){	
		$("#quickTapbox"+i).hide();
	}
