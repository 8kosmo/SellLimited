...
<div id="mypage">
   <ul class="mypage_title">
      ...
      <table class="mypage_table_head">
         <caption>경매 참여 상품 목록 <img src="/images/integ/20150918_10.png"> 
      ...
      <table class="mypage_table">
         <colgroup>
            ...
            <tr>
               ...
               <td>200,000원</td>
               <td>40명</td>
               <td>19-09-22<br>(14:02)</td>
               <td><a href="#"><button type="button">참여</button></a></td>
            </tr>
         </tbody>
      </table>
<%
...
%>
       <table class="mypage_table">
         ...
         <tbody>
            <tr>
               <td height="200" colspan="7">경매 참여 중인 상품이 존재 하지 않습니다.</td>
            </tr>
         </tbody>
      </table>
<%
